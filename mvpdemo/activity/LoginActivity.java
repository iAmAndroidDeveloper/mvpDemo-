...
public class LoginActivity extends BaseActivity<LoginPresenter> implements LoginContract.LoginView {
    ...
    @InjectView(R.id.input_email)   //account number
            EditText inputEmail;
    @InjectView(R.id.input_password) //password
    ...
    public boolean checkNull() {
        ...
        if (TextUtils.isEmpty(getUserName())) {
            inputEmail.setError("Account cannot be empty\n");
            isNull = true;
        } else if (TextUtils.isEmpty(getPwd())) {
            inputPassword.setError("password can not be blank\n");
            isNull = true;
        }
        return isNull;
    }
